        ...
        <div class="box-body">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::select('idusuario', $usuarios, null, array('class' => 'form-control')) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>CRM:</strong>
                    {!! Form::text('crm', null, array('placeholder' => '','class' => 'form-control','style'=>'height:30px' , 'id' => 'crm')) !!}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Assinatura:</strong> Em manutenção
